...
class PermissionController extends Controller
{
    public function index() {
        $permissions = Permission::with('roles')->orderBy('name', 'asc')->paginate(Config::get('constants.LIMIT_PAGINATION'));
    ...
    public function store(Request $request) {
        ...
        //if auth user do not have 'Permission-create' permission
        if(Auth::user()->role_type !== 'administrator' && Auth::user()->cannot('create', Permission::class)) {
            return response()->json([
                'response_index' => true,
                'response_type' => 'Error',
