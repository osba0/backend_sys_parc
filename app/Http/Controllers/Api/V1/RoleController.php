...
class RoleController extends Controller
{
    public function index() {
        $roles = Role::with('permissions')->orderBy('id', 'asc')->paginate(Config::get('constants.LIMIT_PAGINATION'));
    ...
    public function edit($id) {
        ...
        //if auth user do not have 'Roles-edit' permission
        if(Auth::user()->role_type !== 'administrator' && Auth::user()->cannot('edit', Role::class)) {
            $index = false;
    ...
    public function update(Request $request, $id) {
        ...
        if(Auth::user()->role_type !== 'administrator' &&  Auth::user()->cannot('edit_or_delete_super_admin', $role)) {
            return response()->json([
                'response_index' => true,
                'response_type' => 'Error',
    ...
    public function destroy($id) {
        ...
        //if auth user do not have 'Roles-delete' permission
        if(Auth::user()->role_type !== 'administrator' && Auth::user()->cannot('delete', Role::class)) {
            return response()->json([
                'response_index' => true,
                'response_type' => 'Error',
